...
def test__pf():
    ...
    assert numpy.allclose(temps, test_temps)
    ...
    assert numpy.allclose(logq, test_logq)
    ...
    assert numpy.allclose(dq_dt, test_dq_dt)
    ...
    assert numpy.allclose(dq2_dt2, test_dq2_dt2)
